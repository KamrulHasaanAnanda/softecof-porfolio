        ...
        >
            <div className="container mx-auto px-4 sm:px-6">
                <div className="flex items-center justify-between h-16 md:h-20">
                    ...
                    >
                        <div className="relative">
                            <div className="absolute inset-0 bg-green-200/30 rounded-full blur-sm"></div>
                            <img
                                src="/softecof.png"
                                alt="Softecof Logo"
                    ...
                    {/* Mobile Menu Button */}
                    <motion.button
                        className="lg:hidden p-2 rounded-lg text-gray-700 hover:text-green-600 hover:bg-green-50 transition-colors duration-300"
                ...
                <AnimatePresence>
                    {isMenuOpen && (
                        <motion.div
                            className="lg:hidden border-t border-green-200 bg-white/95 backdrop-blur-md"
                            ...
                            <div className="py-4 space-y-4">
                                {navigationItems.map((item, index) => (
                                    <motion.button
                                        key={item.name}
                                        onClick={() => scrollToSection(item.href)}
                                        className="block w-full text-left px-4 py-2 text-gray-700 hover:text-green-600 hover:bg-green-50 rounded-lg font-medium transition-colors duration-300"
                                ...
                                {/* Mobile Contact Info */}
                                <div className="px-4 py-4 border-t border-green-200 space-y-3">
